    ...
    <th width="15%" style="background-color: gainsboro;"><font size="2">Dari</font></th>
    <th width="25%" style="background-color: gainsboro;"><font size="2">Perihal</font></th>
    <th width="15%" style="background-color: gainsboro;"><font size="2">Tujuan Bidang/Unit</font></th>
    <th width="15%" style="background-color: gainsboro;"><font size="2">Keterangan</font></th>
                                          </tr>
                                          </thead>
                                          <tbody>
                  ...
                  <td><font size="2"><?php echo $tampil['indeks_surat_msk']?></font></td>
                  <td align="center"><font size="2"><?php echo $tampil['tgl1']?></font></td>
                  <td><font size="2"><?php echo $tampil['dari']?></font></td>
