...
<thead>
  <tr >
    ...
    <th width="15%" style="background-color: gainsboro;"><font size="2">Tujuan</font></th>
    <th width="20%" style="background-color: gainsboro;"><font size="2">Perihal</font></th>
...
foreach ($sql->result_array() as $tampil){
 ...
 ?> 
    <tr>
      ...
      <td><font size="2"><?php echo $tampil['indeks_surat_klr']?></font></td>
