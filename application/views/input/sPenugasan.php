...
<div class="page-wrapper">
            ...
            <br>
                    ...
                    <p>Total Surat : <?=$sql->num_rows()?><br>
                      Surat Hari ini : <?=$this->M_input->getsNow('tbsurat_penugasan','tgl_terbit')?></p>
                    </div>
                            <div class="card-body">
                              <?php
                                ...
                                <table class="table table-striped table-bordered setkol">
                                    <tr>    
                                                  ...
                                                  <div class="col-md-8">
                                                      <form method="get">
                                                        <div class="input-group">
                                                          <input type="Search" class="form-control" name="strnama" placeholder="Keterangan Surat...">
                                          ...
                                          <tr >
                                            ...
                                            <th ><font size="">Tempat Tujuan</font></th>
                                            <th ><font size="">Mulai Jam</font></th>
                                            <th ><font size="">Akhir Jam</font></th>
                                            <th ><font size="">Dalam Rangka</font></th>
                                            <th ><font size="">Penanda Tangan</font></th>
                                          ...
                                          <?php 
                                            foreach ($sql->result_array() as $tampil){
                                              ...
                                              $nama_jabatan = $tm_cari['nama_jabatan'];
                                               ...
                                               $tm_cari=$this->M_master->jumPersonilPen($tampil['indeks_surat_penugasan'])
                                              ->row_array();
                                              $jml = $tm_cari['jml'];
                                             ?> 
                                                <tr>
                                                  <td align="center"><font size="2"><?php echo $tampil['no_urut']?></font></td>
                                                  <td><font><?php echo $tampil['indeks_surat_penugasan']?></font></td>
                                                  ...
                                                  <td><font><?php echo $tampil['j_mulai']?></font></td>
                                                  <td><font><?php echo $tampil['j_selesai']?></font></td>
                                                  <td><font><?php echo $tampil['perihal']?></font></td>
                                                  <td><font><?php echo $nama_jabatan?></font></td>
                                                  ...
                                                  <td><a href="<?=base_url('C_input/inputPenugsaanNIP/?id='.$tampil['indeks_surat_penugasan'])?>">
                                                    <font size="2"><?=$jml;?></font>
                                                    </a></td>
                                                  
                                                  <td>
                                                    <a   class='open_modal' id='<?=$tampil['indeks_surat_penugasan']; ?>'><i class="fas fa-edit"> Edit</i></a>
                                                    <?php
                                                    $akses=$this->session->userdata('lvl_akses');
                                                    if ($akses==1) {
                                                    ?>            
                                                    <a   class="tom_del"
                                                    onclick="confirm_modal('<?=base_url()?>C_input/sPenugasanDel?&modal_id=<?=$tampil['indeks_surat_penugasan']?>');"><i class="far fa-times-circle"> Hapus</i></a>
                                                  <?php } ?>
                                                  </td>
                                                </tr>
                                             <?php
...
<script type="text/javascript">
   ...
   $(".open_modal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "<?=base_url()?>C_input/sPenugasanEdit",
             type: "GET",
             data : {modal_id: m,},
