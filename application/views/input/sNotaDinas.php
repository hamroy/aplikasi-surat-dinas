...
<div class="page-wrapper">
            ...
            <br>
                    ...
                    <p>Total Surat : <?=$sql->num_rows()?><br>
                      Surat Hari ini : <?=$this->M_input->getsNow('tbsurat_dinas')?></p>
                    </div>
                                             ...
                                             ?> 
                                                <tr>
                                                  ...
                                                  <td>
                                                    ...
                                                    ?>
                                                    <a   class="tom_del"
                                                    onclick="confirm_modal('<?=base_url()?>C_input/sNotaDinasDel?&modal_id=<?=$tampil['indeks_surat_klr']?>');"><i class="far fa-times-circle"> Hapus</i></a>
                                                    <?php } ?>
                                                  </td>
                                                </tr>
                                             <?php
...
<script type="text/javascript">
   ...
   $(".open_modal").click(function(e) {
      var m = $(this).attr("id");
       $.ajax({
             url: "<?=base_url()?>C_input/sNotaDinasEdit",
             type: "GET",
             data : {modal_id: m,},
