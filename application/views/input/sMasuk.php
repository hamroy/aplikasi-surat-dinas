...
<div class="page-wrapper">
  ...
  <div class="well">
    ...
    <p>Total Surat : <?= $sql->num_rows() ?><br>
      Surat Hari ini : <?= $this->M_input->getsNow('tbsurat_msk') ?></p>
  </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered setkol">
        ...
        <tr>
          ...
          <th>
            <font size="">Indeks Surat</font>
          </th>
          <th>
            <font size="">Tanggal Terima</font>
          </th>
          <th>
            <font size="">Tanggal</font>
          </th>
          <th>
            <font size="">Dari</font>
          </th>
          <th>
            <font size="">Perihal</font>
          </th>
          <th>
            <font size="">Bidang/Unit</font>
          </th>
          <th>
            <font size="">Keterangan</font>
          </th>
          <th>
            <font size="">File</font>
          </th>
        ...
        ?>
          <tr>
            <td align="center">
              <font size="2"><?php echo $tampil['no_urut'] ?></font>
            </td>
            <td>
              <font><?php echo $tampil['indeks_surat_msk'] ?></font>
            </td>
            <td align="center">
              <font><?php echo $tampil['tgl1'] ?></font>
            </td>
            <td align="center">
              <font><?php echo $tampil['tgl2'] ?></font>
            </td>
            <td>
              <font><?php echo $tampil['dari'] ?></font>
            </td>
            <td>
              <font><?php echo $tampil['perihal'] ?></font>
            </td>
            <td>
              <font><?php echo $nm_bidang ?></font>
            </td>
            <td>
              <font><?php echo $tampil['keterangan'] ?></font>
            </td>
            ...
            <td>
              <a class='open_modal' id='<?= $tampil['indeks_surat_msk']; ?>'><i class="fas fa-edit"> Edit</i></a>
              <?php
              $akses = $this->session->userdata('lvl_akses');
              if ($akses == 1) {
              ?>
                <a class="tom_del" onclick="confirm_modal('<?= base_url() ?>C_input/sMasukDel?&modal_id=<?= $tampil['indeks_surat_msk'] ?>');"><i class="far fa-times-circle"> Hapus</i></a>
              <?php } ?>
            </td>
          </tr>
        <?php
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?= base_url() ?>C_input/suratMasuk_save" name="modal_popup" enctype="multipart/form-data" method="POST">

          <table class="table1" width="100%">
            <tr>
              <td width="50%"><b>Indeks Surat :</b></td>
            </tr>
            <tr>
              <td width="50%"><input type="text" name="txtindeks" class="form-control" required /></td>
            </tr>
            <tr>
              <td width="50%"><b>Tanggal Terima Surat :</b></td>
              <td width="50%"><b>Tanggal Surat :</b></td>
            </tr>
            <tr>
              <td width="50%"><input type="text" name="tanggalterima" id="tanggal1" class="form-control" required /></td>
              <td width="50%"><input type="text" name="tanggal" id="tanggal2" class="form-control" required /></td>
            </tr>
            <tr>
...
<script type="text/javascript">
  $(document).ready(function() {
    $(".open_modal").click(function(e) {
      var m = $(this).attr("id");
      $.ajax({
        url: "<?= base_url() ?>C_input/sMasukEdit",
        type: "GET",
        data: {
          modal_id: m,
        },
