...
<div class="page-wrapper">
            ...
            <br>
                    <div class="well">
                    <a href="<?=base_url('C_input/formKlasifikasi/6')?>" class="btn btn-success">Tambah Data</a>
                    <br><br>
                    <p>Total Surat : <?=$sql->num_rows()?><br>
                      Surat Hari ini : <?=$this->M_input->getsTNow()?></p>
                    </div>
                                            ...
                                            foreach ($sql->result_array() as $tampil){
                                             ...
                                             ?> 
                                                <tr>
                                                  ...
                                                  <td>
                                                    <a href="<?=base_url('C_input/inputSptNIP/?id='.$tampil['indeks_surat_spt'])?>">
                                                  ...
                                                  <td>
                                                    ...
                                                    ?>
                                                    <a   class="tom_del"
                                                    onclick="confirm_modal('<?=base_url()?>C_input/sPTADel?&modal_id=<?=$tampil['indeks_surat_spt']?>');"><i class="far fa-times-circle"> Hapus</i></a>
                                                  <?php } ?>
                                                  </td>
                                                </tr>
                                             <?php
