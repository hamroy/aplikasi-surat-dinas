...
<div class="page-wrapper">
            ...
            <div class="container-fluid " >
                        ...
                        <div class="card">
                            <div class="card-body" style="background-color: antiquewhite; border-radius: 5px">
                              <?php
            ...
            <table class="table table-bordered" >                      
              <tr>
                <td width="25%"><b>Nomor Indeks Khusus Reg. Diluar BKPSDM :</b></td>
                <td colspan="3"><b>Klasifikasi Surat :</b></td>
              </tr>
              <tr>
                <td width="25%"><input type="text" name="txtno"  class="form-control" /></td>
                <td colspan="3">
              ...
              <tr>
                ...
                <td colspan="2">
                  <select name="cbojenisx" id="cbojenis" class="form-control" disabled>
                    ...
                    <?php
                      $sql_row=$this->M_master->getKdJenisSurat(6);
                  ...
                  <input type="hidden" name="cbojenis" value="SPT-KEU">
                </td>
              </tr>
              <!--201910  -->
              <tr>
              ...
              <tr>
                ...
                <td colspan="2">
                  <select name="cbokegiatan" id="cbokegiatan" class="form-control" required>
                    <option value=""></option>
                    <?php
              ...
              <tr>
                <td width="25%"><input type="text" name="tanggal" autocomplete="off" id="tanggal1" class="form-control" required/></td>
                <td width="25%"><input type="text" name="tanggal1" autocomplete="off" id="tanggal2" class="form-control" required/></td>
