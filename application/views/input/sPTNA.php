...
<div class="page-wrapper">
  ...
  <br>
  <div class="well">
    <a href="<?= base_url('C_input/formKlasifikasi/8') ?>" class="btn btn-success">Tambah Data</a>
    <br><br>
    <p>Total Surat : <?= $sql->num_rows() ?>
      <br>
      Surat Hari ini : <?= $this->M_input->getsTNow() ?>
    </p>
  </div>
    ...
    <div class="table-responsive">
      <table class="table table-striped table-bordered setkol">
        ...
        <tr>
          ...
          <th>
            <font size="">Tgl Penetapan</font>
          </th>
          <th>
            <font size="">Tgl Mulai</font>
          </th>
          <th>
            <font size="">Tgl Akhir</font>
          </th>
          <th>
            <font size="">Tujuan</font>
          </th>
          <th>
            <font size="">Perihal</font>
          </th>
          <th>
            <font size="">Bidang</font>
          </th>
          <th>
            <font size="">Kegiatan</font>
          </th>
          <th>
          ...
          <th>
            <font size="">Jumlah Personil</font>
          </th>
          <th>
            <font size="">Menu</font>
          </th>
        ...
        ?>
          <tr>
            ...
            <td>
              <font><?php echo $tampil['indeks_surat_spt'] ?></font>
            </td>
            <td align="center">
              <font><?php echo $tampil['tgl3'] ?></font>
            </td>
            <td align="center">
            ...
            <td>
              <font><?php echo $tampil['tujuan'] ?></font>
            </td>
            <td>
            ...
            <td>
              <font><?php echo $nm_kegiatan ?></font>
            </td>
            <td>
            ...
            <td><a href="<?= base_url('C_input/inputSptNIP/?id=' . $tampil['indeks_surat_spt']) ?>">
                <font size="2"><?= $jml; ?></font>
              </a>
            </td>

            <td>
              <a class='open_modal' id='<?= $tampil['indeks_surat_spt']; ?>'><i class="fas fa-edit"> Edit</i></a>
              <?php
              $akses = $this->session->userdata('lvl_akses');
              if ($akses == 1) {
              ?>
                <a class="tom_del" onclick="confirm_modal('<?= base_url() ?>C_input/sPTADel?&modal_id=<?= $tampil['indeks_surat_spt'] ?>');"><i class="far fa-times-circle"> Hapus</i></a>
              <?php } ?>
            </td>
          </tr>
        <?php
