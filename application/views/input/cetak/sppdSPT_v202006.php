...
<div id="bagkanan" style="padding-right: 100px">
  <?php
  $no=1;
...
<p id="bagkiri">Tujuan  <span style="float: right; margin-right: 15px">:</span></p>
<div id="bagkanan">
<p><?=$tujuan?> <?=$tujuan?></p>
</div>
</div>
...
<p id="bagkiri">Tanggal Berangkat  <span style="float: right; margin-right: 15px">:</span></p>
<div id="bagkanan">
<p><?=$tgl_mulai?></p>
</div>
</div>
...
<p id="bagkiri">Tanggal Kembali  <span style="float: right; margin-right: 15px">:</span></p>
<div id="bagkanan">
<p><?=$tgl_selesai?></p>
</div>
</div>
