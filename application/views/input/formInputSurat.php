                            ...
                            <div class="card-body">
                              ...
                              <div class="table-responsive">
                                    <!-- ISI -->
                                            ...
                                            <form action="<?=base_url('C_input/suratKeluar_save')?>" name="modal_popup" enctype="multipart/form-data" method="POST">
                                        <table class="table table-bordered">
                                          <tr>    
                                                      <td>
                                                <table class="table1" width="100%">
                                                  ...
                                                  <tr>
                                                    ...
                                                    <td width="25%">
                                                      <input type="text" autocomplete="off" name="tanggal" id="tanggal" class="form-control" required/>
                                                    </td>
                                                  </tr>
                                                  <!--201910  -->
                                                  <tr>
