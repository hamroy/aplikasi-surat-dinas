      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-bordered">
          ...
          ?>
            <tr>
              <td>
                <font size=""><?php echo $tampil['kd_klasifikasi'] ?></font>
              </td>
              <td>
                <font size=""><?php echo $tampil['nm_klasifikasi'] ?></font>
              </td>
              <td>
                <font size=""><?php echo $tampil['keterangan'] ?></font>
              </td>
              <td>
                <button class="btn btn-info btn-sm open_modal" id='<?php echo  $tampil['id']; ?>'><i class="fas fa-edit"> Edit</i></button>
                <?php
                $akses = $this->session->userdata('lvl_akses');
                if ($akses == 1) {
                ?>
                  <button class="btn btn-danger btn-sm" onclick="confirm_modal('<?= base_url() ?>C_master/klasifikasidel?&modal_id=<?= $tampil['id'] ?>');"><i class="far fa-times-circle"> Hapus</i></button>
                <?php
                }
                ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Input Klasifikasi</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      </div>

      <div class="modal-body">
        <form action="C_master/klasifikasi_save" name="modal_popup" enctype="multipart/form-data" method="POST">
...
<div class="modal fade" id="modal_delete">
  <div class="modal-dialog">
    <div class="modal-content" style="margin-top:100px;">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Hapus Klasifikasi</h4>
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
      </div>
