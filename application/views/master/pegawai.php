      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-bordered">
          ...
          foreach ($sql->result_array() as $tampil) {
            $pangkat = $tampil['id_pangkat'];
            $tm_cariP = $this->M_master->getPangkatId($pangkat)->row_array();
            if (isset($tm_cariP['nm_pangkat'])) {
              $pangkat = $tm_cariP['nm_pangkat'];
            }
          ?>
            <tr>
              <td>
                <font size=""><?php echo $tampil['nip'] ?></font>
              </td>
              <td>
                <font size=""><?php echo $tampil['nama'] ?></font>
              </td>
              <td>
                <font size=""><?php echo $pangkat ?></font>
              </td>
              <td>
                <font size=""><?php echo $tampil['nama_jabatan'] ?></font>
              </td>
              <td>
                ...
                if ($akses == 1) {
                ?>
                  <button class="btn btn-danger btn-sm" href="#d" onclick="confirm_modal('<?= base_url() ?>C_master/pegawaiDel?&modal_id=<?= $tampil['id'] ?>');"><i class="far fa-times-circle"> Hapus</i></button>
                <?php
                }
                ?>
