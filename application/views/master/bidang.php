      ...
      <div class="card-body">
        ...
        <table class="table table-striped table-bordered">
          ...
          ?>
            <tr>
              <td>
                <font size=""><?php echo $tampil['kd_bidang'] ?></font>
              </td>
              <td>
                <font size=""><?php echo $tampil['nm_bidang'] ?></font>
              </td>
              <td>
                <button class="btn btn-info btn-sm open_modal" id='<?php echo  $tampil['id']; ?>'><i class="fas fa-edit"> Edit</i></button>
                <button class="btn btn-danger btn-sm open_modal" onclick="confirm_modal('<?= base_url() ?>C_master/bidangDel?&modal_id=<?= $tampil['id'] ?>');"><i class="far fa-times-circle"> Hapus</i></button>
              </td>
            </tr>
          <?php
          }
