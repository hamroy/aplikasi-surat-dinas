                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item <?=$ma?>"> 
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                ...
                                <li class="sidebar-item">
                                    <a href="<?=base_url('C_master/Instansi')?>" class="sidebar-link">
                                    <span class="hide-menu"> Instansi </span>
                                    </a>
                                </li>

                                <li class="sidebar-item">
                                    <a href="<?=base_url('C_master/jsurat')?>" class="sidebar-link">
                                    <span class="hide-menu"> Jenis Surat </span>
                                    </a>
                                </li> 

                                <li class="sidebar-item">
                                    <a href="<?=base_url('C_master/bidang')?>" class="sidebar-link">
                                    <span class="hide-menu"> Bidang </span>
                                    </a>
                                </li> 

                                <li class="sidebar-item">
                                    <a href="<?=base_url('C_master/kegiatan')?>" class="sidebar-link">
                                ...
                                <li class="sidebar-item">
                                    <a href="<?=base_url('C_master/user')?>" class="sidebar-link">
                        ...
                        <li class="sidebar-item <?=$li?>"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                 <li class="sidebar-item"><a href="<?=base_url('C_agenda')?>" class="sidebar-link"><span
                        ...
                        <!-- LAPORAN -->
                            <li class="sidebar-item <?=$la?>"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i class="fas fa-clipboard-list"></i><span
                                    class="hide-menu">LAPORAN AGENDA</span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                        ...
                        <li class="list-divider"></li>
                        <!-- SETTING SISTEM -->
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link active" href="<?=base_url('C_sett')?>"
                        aria-expanded="false"><i class="fas fa-cog"></i>
                            <span class="hide-menu">SETTING SISTEM</span></a>
                        </li>
                        <!-- MENU CETAK -->
                        <li class="sidebar-item <?=$cet?>"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                                aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span
                                    class="hide-menu">CETAK </span></a>
                            <ul aria-expanded="false" class="collapse  first-level base-level-line" >
                                <li class="sidebar-item" >
                                    <a href="<?=base_url('C_cetakSurat')?>" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Surat Keluar </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Surat Masuk </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Surat Keputusan </span>
                                    </a>
                                </li>
                                
                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak SPT Anggaran </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak SPT Non Anggaran </span>
                                    </a>
                                </li> 

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Surat Perjalanan Dinas </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Lap Perjalanan Dinas </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" >Cetak Surat Penugasan </span>
                                    </a>
                                </li>

                                <li class="sidebar-item" >
                                    <a href="#" class="sidebar-link">
                                        <span class="hide-menu" > Cetak Nota Dinas </span>
                                    </a>
                                </li>
                            </ul>
                        </li>
