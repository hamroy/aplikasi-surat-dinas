                                ...
                                <table class="table table-striped table-bordered setkol">
                                    <tr>    
                                          ...
                                          <tr >
                                            ...
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Indeks Surat</font></th>
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Nama Pegawai</font></th>
                                            <th width="8%" style="background-color: gainsboro;"><font size="2">NIP</font></th>
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Jabatan</font></th>
                                            <th width="8%" style="background-color: gainsboro;text-align:center;"><font size="2">Tgl Mulai</font></th>
                                            <th width="8%" style="background-color: gainsboro;text-align:center;"><font size="2">Tgl Akhir</font></th>
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Tujuan</font></th>
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Perihal</font></th>
                                            <th width="9%" style="background-color: gainsboro;"><font size="2">Bidang</font></th>
                                            <th width="10%" style="background-color: gainsboro;"><font size="2">Kegiatan</font></th>
                                            <th width="7%" style="background-color: gainsboro;"><font size="2">Keterangan</font></th>
                                          </tr>

                                          <?php 
                                            foreach ($sql->result_array() as $tampil){

                                              $tm_cari=$this->M_master->getKegiatanId($tampil['id_kegiatan'])->row_array();
                                              $nama_jabatan = $tm_cari['nm_kegiatan'];
                                             ...
                                             ?> 
                                                <tr>
                                                  ...
                                                  <td><font size="2"><?php echo $tampil['indeks_surat_spt']?></font></td>

                                                  <td><font size="2"><?php echo $nama?></font></td>
                                                  <td><font size="2"><?php echo $nip1?></font></td>
                                                  <td><font size="2"><?php echo $nama_jabatan?></font></td>

                                                  <td align="center"><font size="2"><?php echo $tampil['tgl1']?></font></td>
                                                  <td align="center"><font size="2"><?php echo $tampil['tgl2']?></font></td>
                                                  ...
                                                  <td><font size="2"><?php echo $nm_kegiatan?></font></td>
